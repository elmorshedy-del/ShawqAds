...
- **What went wrong:**
  ...
  - PR #33 separately changed KPI tie logic so **ties** counted as all-time highs — intraday revenue/orders showed “still climbing” and fired confetti on a tie, not a new record.
