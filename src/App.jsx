...
const DEMO_PURCHASES = [
  { id: 'demo-1', name: '#3940', country: 'Canada', city: 'Toronto', region: 'ON', countryCode: 'CA', flag: '🇨🇦', amount: 95.99, currency: 'USD', items: 1, product: 'ShawQ Signature Hoodie', source: 'Meta · Prospecting', coordinates: [-79.3832, 43.6532], time: 'Just now' },
  { id: 'demo-2', name: '#3939', country: 'USA · New York', city: 'New York', region: 'NY', countryCode: 'US', flag: '🇺🇸', amount: 142, currency: 'USD', items: 2, product: 'ShawQ Tee 2-Pack', source: 'Meta · Retargeting', coordinates: [-74.006, 40.7128], time: '2m ago' },
  { id: 'demo-3', name: '#3938', country: 'USA · California', city: 'Los Angeles', region: 'CA', countryCode: 'US', flag: '🇺🇸', amount: 88.5, currency: 'USD', items: 1, product: 'ShawQ Cap', source: 'Organic', coordinates: [-118.2437, 34.0522], time: '8m ago' },
  { id: 'demo-4', name: '#3937', country: 'USA · Colorado', city: 'Denver', region: 'CO', countryCode: 'US', flag: '🇺🇸', amount: 64, currency: 'USD', items: 1, product: 'ShawQ Tee', source: 'Meta · Prospecting', coordinates: [-104.9903, 39.7392], time: '15m ago' },
  { id: 'demo-5', name: '#3936', country: 'France', city: 'Paris', region: undefined, countryCode: 'FR', flag: '🇫🇷', amount: 120, currency: 'EUR', items: 2, product: 'ShawQ Hoodie', source: 'Meta · Prospecting', coordinates: [2.3522, 48.8566], time: '23m ago' },
  { id: 'demo-6', name: '#3935', country: 'Germany', city: 'Berlin', region: undefined, countryCode: 'DE', flag: '🇩🇪', amount: 75, currency: 'EUR', items: 1, product: 'ShawQ Tee', source: 'Organic', coordinates: [13.405, 52.52], time: '34m ago' },
  { id: 'demo-7', name: '#3934', country: 'United Kingdom', city: 'London', region: undefined, countryCode: 'GB', flag: '🇬🇧', amount: 99, currency: 'GBP', items: 1, product: 'ShawQ Cap', source: 'Meta · Retargeting', coordinates: [-0.1276, 51.5072], time: '48m ago' },
  { id: 'demo-8', name: '#3933', country: 'Australia', city: 'Sydney', region: undefined, countryCode: 'AU', flag: '🇦🇺', amount: 130, currency: 'AUD', items: 2, product: 'ShawQ Hoodie', source: 'Organic', coordinates: [151.2093, -33.8688], time: '1h ago' },
];
