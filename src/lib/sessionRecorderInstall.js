...
function identity(){var clientId=readCookie('_shopify_y')||readCookie(cookieName('virona_si_client_id'))||'';var shopifySession=readCookie('_shopify_s')||'';var sessionId=readCookie(cookieName('virona_si_session_id'))||(clientId&&shopifySession?clientId+':'+shopifySession.slice(0,12):'');return{sessionId:sessionId,clientId:clientId};}
